...
//   ngAfterViewInit() {
//     this.cdr.detectChanges(); // Garante que todas as mudanças são detectadas após a view estar inicializada
//   }
...
//           (response) => {
//             this.filmeFavoritado = false; // Atualiza o estado do favorito
//             this.mensagem = "Filme desfavoritado com sucesso!";
//             // Remover a chamada à verificação, pois já sabemos que foi desfavoritado
//           },
//           (error) => {
...
//           (response) => {
//             this.filmeFavoritado = true; // Atualiza o estado do favorito
